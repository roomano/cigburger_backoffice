...
<div class="container-fluid">
    <div class="row">
        <div class="col content-box p-5">
            ...
            <div class="row">
                <div class="col">
                    <?= form_open('/stock/add-submit', ['novalidate' => true]) ?>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-12 mb-3">
                                <label for="textSupplier" class="form-label">Fornecedor</label>
                                <input type="text" list='listSuppliers' name="textSupplier" id="textSupplier" class="form-control" value="<?= old('textSupplier') ?>">
                                <?= displayError('textSupplier', $validationErrors) ?>

                                <datalist class="" id="listSuppliers">
                                    <?php foreach ($listSuppliers as $suplier) : ?>
                                        <option value="<?= $suplier->stock_supplier ?>">
                                        <?php endforeach; ?>
                                </datalist>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-12 mb-3">
                                ...
                                <input type="text" name="textDate" id="textDate" value="<?= old('textDate'), date('Y-m-d H:i') ?>" class="form-control">
                        ...
                        <div class="">
                            ...
                            <button type="submit" class="btn btn-success fw-bold"><i class="fas fa-check me-2"></i>Registar entrada</button>
                        </div>
                    </div>
                    <?= form_close() ?>
                </div>
